...
with col1:
    start_date = st.date_input("Start Date", value=pd.to_datetime("2023-12-09"))
with col2:
    end_date = st.date_input("End Date", value=pd.to_datetime("2024-12-10"))
...
if 'final_pairs' not in st.session_state or st.session_state['final_pairs'].empty:
    ...
    with col3:
        view_start_date = st.date_input("Start Date", value=pd.to_datetime("2024-06-09"))
    with col4:
        view_end_date = st.date_input("End Date", value=pd.to_datetime("2024-12-10"))
